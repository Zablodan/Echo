...
public class AnalyzeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter = new Filter(filePath);

        fragmentTransaction = getFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.content_frame, new ResultAnalyzeFragment());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_results) {
            fragmentManager.beginTransaction()
                    .replace(R.id.content_frame, new ResultAnalyzeFragment())
                    .commit();
            getSupportActionBar().setTitle("Results");

        } else if (id == R.id.nav_plot) {
            fragmentManager.beginTransaction()
                    .replace(R.id.content_frame, new PlotAnalyzeFragment())
                    .commit();
